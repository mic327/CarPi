...
from PyQt5.QtMultimedia import QRadioTuner
...
class PlaylistWindow(QMainWindow, blank_window.Ui_BlankWindow):
    def __init__(self):
        ...
        self.setWindowFlags(QtCore.Qt.FramelessWindowHint)
        self.setStyleSheet(open("resources/style.qss", "r").read())
        self.PlaylistsWindowSelect = ListPlaylists("/home/michal/Playlists/")
...
class PlaylistWindowCreate(QMainWindow, blank_window.Ui_BlankWindow):
    def __init__(self, Edit=False, Playlist="None"):
        ...
        if (self.Edit == True):
            self.PlaylistsWindowCreate = ListPlaylists("/home/michal/Muzyka/", True)
            # opcjonalnie dodaję przycisk kasowania playlisty
            self.DeletePlaylistButton = RadioPlayWindow.drawControlFMButton(self, "Usun", 700, 160, "#fe022c",
                                                                            "delete.png")
            ...
            self.PlaylistsWindowCreate = ListPlaylists("/home/michal/Muzyka/")
    ...
    def deletePlaylist(self):
        os.system("rm /home/michal/Playlists/" + str(self.Playlist))
        self.close()
        self.PlaylistsWindowCreate.close()
...
class SelectFMWindow(QMainWindow, blank_window.Ui_BlankWindow):
    ...
    def __init__(self, kind):
        ...
        if (kind == 'normal'):
            ...
            self.test.setText(_translate("MainWindow",
                                         "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Wszystkie stacje:</span></p><p><br/></p></body></html>"))
            # wyświetlam etykietę
            self.test.show()
        else:
            self.test = QtWidgets.QLabel("sd", self)
            ...
            _translate = QtCore.QCoreApplication.translate
            self.test.setText(_translate("MainWindow",
                                         "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Ulubione stacje:</span></p><p><br/></p></body></html>"))
            self.test.show()
    ...
    def playStation(self, sender, kind):
        self.tuner = QRadioTuner()
        print(self.tuner.availability())
        ...
        FMPlayString = "sudo pkill arecord;sudo pkill -9 aplay;sudo pkill -9 rtl_fm;sudo rtl_fm -f " + str(
            Frequency) + "e6 -s 200000 -r 48000 | aplay -r 48000 -f S16_LE &"
    ...
    def drawStationsButtons(self, kind, offset):
        ...
        while self.StationsListLength > 0:
            ...
            _translate = QtCore.QCoreApplication.translate
            self.StationsListLabels[self.i].setText(_translate("MainWindow",
                                                               "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">" +
                                                               StationsList[
                                                                   self.i] + "</span></p><p><br/></p></body></html>"))
        ...
        if (self.StationsCount > (offset + 4)):
            ...
            _translate = QtCore.QCoreApplication.translate
            self.LabelForward.setText(_translate("MainWindow",
                                                 "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Następne</span></p><p><br/></p></body></html>"))
        ...
        if (offset != 0):
            ...
            _translate = QtCore.QCoreApplication.translate
            self.LabelBackward.setText(_translate("MainWindow",
                                                  "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Poprzednie</span></p><p><br/></p></body></html>"))
...
class RadioPlayWindow(QMainWindow, blank_window.Ui_BlankWindow):
    def __init__(self, sender, kind):
        ...
        _translate = QtCore.QCoreApplication.translate
        self.RadioName.setText(_translate("MainWindow",
                                          "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">" + sender + "</span></p><p><br/></p></body></html>"))
        self.RadioName.show()
    ...
    def drawControlFMButton(self, objectname, offset_x, offset_y, background, image):
        ...
        self.ControlFMButton.setStyleSheet(
            "QPushButton{background:" + str(background) + " url(:/images/" + str(image) + ")}")
    ...
    def drawControlButtonLabel(self, offset_x, offset_y, label):
        ...
        _translate = QtCore.QCoreApplication.translate
        self.ControlFMButtonLabel.setText(_translate("MainWindow",
                                                     "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">" + str(
                                                         label) + "</span></p><p><br/></p></body></html>"))
