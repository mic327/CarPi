...
class Ui_SettingsWindow(object):
    ...
    def retranslateUi(self, SettingsWindow):
        ...
        self.label_15.setText(_translate("SettingsWindow", "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Domyœlna g³oœnoœæ:</span></p><p><br/></p></body></html>"))
        self.label_16.setText(_translate("SettingsWindow", "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Domyœlna jasnoœæ:</span></p><p><br/></p></body></html>"))
